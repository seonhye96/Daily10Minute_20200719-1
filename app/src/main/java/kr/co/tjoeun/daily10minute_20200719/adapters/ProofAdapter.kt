...
//        인증일시 : 2020년 6월 9일 오전 2시 8분 양식으로 직접 출력
//        data의 proofTime 변수를 활용하자
//        String으로 변환 => SimpleDateFormat 기능 활용
...
//        그림이 있느냐? 없느냐? 구별 해야함 =? How? data의 이미지 주소 목록의 크기값 확인
...
//        만약, 이미 좋아요를 찍은 글이라면?
        if(data.myLike){
            likeBtn.text = "좋아요 취수 ${data.likeCount}개"
        }
