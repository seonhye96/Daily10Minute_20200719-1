...
//        원하는 프로젝트의 상세정보를 불러오는 기능
        ...
        fun getRequestProjectDetail(context: Context, proofId: Int, handler: JsonResponseHandler?) {
...
//            GET / DELETE방식의 파라미터 첨부는 query에 담아야 함.
//            주소에 붙여주는 방식 => 쉽게 가공하도록 도와주는 변수 생성.
            val urlBuilder = "${BASE_URL}/project/${proofId}".toHttpUrlOrNull()!!.newBuilder()
//            urlBuilder.addEncodedQueryParameter("이름표", "전달값")
...
//--------------------        프로젝트의 상세정보 + 날짜별 인증 게시글 목록 API 호출
        ...
        fun getRequestProjectNotificationList(context: Context, handler: JsonResponseHandler?) {
